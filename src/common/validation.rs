...
mod tests {
    ...
    fn test_name() {
        ...
        assert_eq!(
            name(Path::new("./target/debug/peiosutils")),
            Some("peiosutils")
        );
